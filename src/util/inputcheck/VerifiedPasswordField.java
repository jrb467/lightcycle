...
public class VerifiedPasswordField extends JPasswordField implements CaretListener{
	...
	public VerifiedPasswordField(){
		super();
		this.addCaretListener(this);
		validateField();
	}
	
	public VerifiedPasswordField(JLabel label){
		super();
		errorLabel = label;
		this.addCaretListener(this);
		validateField();
